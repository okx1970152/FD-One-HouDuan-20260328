...
import (
	...
	"github.com/router-for-me/CLIProxyAPI/v6/internal/oauthconfig"
...
var (
	geminiOAuthClientID     = oauthconfig.GeminiClientID()
	geminiOAuthClientSecret = oauthconfig.GeminiClientSecret()
)
...
var (
	antigravityOAuthClientID     = oauthconfig.AntigravityClientID()
	antigravityOAuthClientSecret = oauthconfig.AntigravityClientSecret()
)
